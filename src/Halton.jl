...
"""
    `HaltonSeq!{T<:AbstractFloat}(H::Vector{T}, B::Int; skip::Int=0)`
...
"""
function HaltonSeq!(H::AbstractArray{T}, B::Int; skip::Int=0) where {T<:AbstractFloat}
  isprime(B) || error("base number not prime")
  H!(H, B, skip)
end

"""
    `HaltonDraws!{T<:AbstractFloat}(H::Vector{T}, B::Int, [skip::Int=0, distr=Normal()])`
...
Keyword argument `skip` is the number initial "burn-in" elements to drop.
"""
function HaltonDraws!(H::AbstractArray, B::Int; skip::Int=0, distr = Normal())
